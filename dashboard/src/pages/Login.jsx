      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card {
          ...
          width: 100%; max-width: 400px; padding: 48px 40px 40px;
        }
        .header { text-align: center; margin-bottom: 36px; }
        .logo-mark {
          display: inline-flex; align-items: center; justify-content: center;
          width: 56px; height: 56px; background: #f5f5f7;
          border-radius: 16px; margin-bottom: 20px; font-size: 26px;
        }
        .header h1 { font-size: 22px; font-weight: 600; color: #1d1d1f; letter-spacing: -0.4px; margin-bottom: 6px; }
        ...
        .field-input {
          ...
          padding: 14px 16px; font-family: inherit; font-size: 16px; color: #1d1d1f;
        ...
        .field-input:focus { background: #fff; border-color: #0071e3; box-shadow: 0 0 0 3px rgba(0,113,227,0.12); }
        ...
        .error-msg {
          font-size: 13px; color: #ff3b30; background: rgba(255,59,48,0.06);
          border-radius: 8px; padding: 10px 14px; margin-bottom: 12px; text-align: center;
        }
        .submit-btn {
            ...
            <div className="fields">
              ...
              <div className="field">
                ...
                <div className="pass-wrap">
                  <input id="password" className="field-input"
