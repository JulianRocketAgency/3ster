...
export async function sendReservationConfirmation({ name, email, date, time, guests, notes }) {
  ...
  try {
    const logoPath = "/Users/julian/Agency/3ster/dashboard/public/rocket-agency-transparent.png";
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:#f5f5f7;padding:24px 40px;border-top:1px solid #e5e5ea;text-align:center;">
              ...
              ${logoAttachment ? `<img src="cid:rocket-agency-logo" alt="Rocket Agency" style="height:80px;width:auto;" />` : `<strong style="color:#1d1d1f;">Rocket Agency</strong>`}
...
<body style="margin:0;padding:0;background:#f5f5f7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f5f7;padding:40px 0;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        <tr><td style="background:#1d1d1f;padding:32px 40px;text-align:center;">
          <p style="margin:0;font-size:28px;font-weight:700;color:#ffffff;">De 3 Ster</p>
          <p style="margin:6px 0 0;font-size:13px;color:#86868b;letter-spacing:2px;text-transform:uppercase;">Eetcafé · Otterlo</p>
        </td></tr>
        <tr><td style="padding:40px 40px 32px;">
          <p style="margin:0 0 8px;font-size:22px;font-weight:600;color:#1d1d1f;">Uw reservering is bevestigd!</p>
          <p style="margin:0 0 32px;font-size:15px;color:#86868b;line-height:1.6;">Beste ${name}, wij kijken ernaar uit u te verwelkomen bij De 3 Ster.</p>
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f5f7;border-radius:12px;overflow:hidden;margin-bottom:32px;">
            <tr><td style="padding:24px 28px;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr><td style="padding:8px 0;border-bottom:1px solid #e5e5ea;">
        ...
        <tr><td style="background:#f5f5f7;padding:24px 40px;border-top:1px solid #e5e5ea;text-align:center;">
          <p style="margin:0 0 12px;font-size:11px;color:#aeaeb2;">Reserveringssysteem mogelijk gemaakt door</p>
          <img src="cid:rocket-agency-logo" alt="Rocket Agency" style="height:80px;width:auto;" />
          <p style="margin:8px 0 0;"><a href="https://www.rocket-agency.nl" style="font-size:11px;color:#aeaeb2;text-decoration:none;">www.rocket-agency.nl</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
  ...
  try {
    const logoPath = "/Users/julian/Agency/3ster/dashboard/public/rocket-agency-transparent.png";
    const logoData = readFileSync(logoPath);
    logoAttachment = { filename: "rocket-agency.png", content: logoData, cid: "rocket-agency-logo" };
  } catch(e) {}
